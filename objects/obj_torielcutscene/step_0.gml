if x<(room_width/2 - sprite_width/2) then 
if conversation=0
{
...
if global.faceemotion=1 then sprite_index=spr_torielside1
if global.faceemotion=2 then sprite_index=spr_torielcutscene
