...
if global.bmenucoord[1] < 0 then global.bmenucoord[1] = 2
if global.monster[0] = 0 and global.monster[2] = 0 then global.bmenucoord[1] = 1
if global.bmenucoord[1] = 2 and global.monster[2] = 0 then global.bmenucoord[1] = 1
if global.bmenucoord[1] = 1 and global.monster[1] = 0 then global.bmenucoord[1] = 0
if global.bmenucoord[1] = 0 and global.monster[0] = 0 then global.bmenucoord[1] = 2
}

if global.bmenuno = 10 then
{
if global.bmenucoord[2] != 0 and global.bmenucoord[2] != 3 then global.bmenucoord[2] -= 1
