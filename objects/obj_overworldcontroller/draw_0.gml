...
if global.menuchoice[0]=1 then draw_text(42+xx,84+yy,'ITEM')
if global.menuchoice[1]=1 draw_text(42+xx,102+yy,'STAT')
if global.menuchoice[2]=1 draw_text(42+xx,120+yy,'CELL')
// draw item names
...
if global.menuno=6 then //put item in storage
      {
      scr_itemname();
      for (i=0;i<8;i+=1) draw_text(116+xx,30+yy+(i*16),global.itemname[i]);
      }
...
if global.menuno=2  //status screen
 ...
 //  draw_text(108+xx,94+yy,"EN  " +string(global.en) +" / " + string(global.maxen))
   draw_text(108+xx,110+yy,"AT  " +string(global.at) +" (" + string(global.wstrength) + ")")
   draw_text(108+xx,126+yy,"DF  " +string(global.df) +" (" + string(global.adef) + ")")
   ...
   draw_text(108+xx, 192+yy, "GILD: " + string(global.gold))
   if global.kills>20 then draw_text(192+xx, 192+yy, "KILLS: " + string(global.kills))
...
if keyboard_multicheck_pressed(vk_enter)
   ...
   if global.menuno=7 then
          {    
           ...
           if noroom=0 then
             ...
             script_execute(scr_storageshift,global.menucoord[7],0,300)
             }
   ...
   if global.menuno=4 then script_execute(scr_save)
